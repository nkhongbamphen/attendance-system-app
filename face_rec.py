...
# redis-19968.c257.us-east-1-3.ec2.redns.redis-cloud.com:19968
# 4vB8DkhC4TNFsfW5SgMOUIdPZnswSdID
...
class RegistrationForm:
    ...
    def save_data_in_redis_db(self,name,role):
        ...
        x_array = np.loadtxt('face_embedding.txt',dtype=np.float32) # flaten array
